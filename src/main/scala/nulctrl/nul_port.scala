...
class nul_port extends Bundle {
    ...
    val dbg_s2_tlb_resp_ae_inst = Bool()
    val dbg_s2_tlb_resp_pf_inst = Bool()
    val dbg_s2_tlb_resp_gf_inst = Bool()
    val dbg_tlb_hits = UInt(14.W)
    val dbg_px_array = UInt(14.W)
    val dbg_final_ae_array = UInt(14.W)
    val dbg_ptw_ae_array = UInt(14.W)
    ...
    val ibuf_io_imem_valid = Bool()
    val ibuf_io_imem_bits_pc = UInt(40.W)
    val ibuf_io_imem_bits_replay = Bool()
    val ibuf_io_imem_bits_btb_cfiType = UInt(2.W)
